    ...
    <i class="fab fa-500px"></i>
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="admin">
          ...
          <a class="nav-link" href="index.php?menu=2">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Managemen Karyawan</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Register">
          <a class="nav-link" href="index.php?menu=3">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Managemen Divisi</span>
          </a>
        </li>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Register">
          <a class="nav-link" href="index.php?menu=4">
            <i class="fa fa-fw fa-table"></i>
